...
const isMyseedstory = computed(() => layoutVariant.value === 'myseedstory')
</script>
...
<template>
  <AppLayout :variant="layoutVariant">
    <section
      ...
      :class="isMyseedstory ? 'bg-myseedstory-parch' : 'bg-white'"
    >
      <div class="max-w-3xl mx-auto">
        <!-- Section label (myseedstory only) -->
        <div v-if="isMyseedstory" class="flex items-center gap-3 mb-6">
        ...
        <h1
          :class="
            isMyseedstory
              ? 'font-display text-5xl sm:text-6xl font-semibold text-myseedstory-forest tracking-tight leading-[0.98] mb-10'
        ...
        <div :class="isMyseedstory ? 'space-y-10 text-myseedstory-forest/80' : 'prose max-w-none'">
          <!-- How to Delete -->
          <div>
            <h2
              :class="
                isMyseedstory
                  ? 'font-display text-2xl text-myseedstory-forest mb-4 tracking-tight'
            ...
            <p :class="isMyseedstory ? 'mb-5 text-[15px] leading-relaxed' : 'mb-4 text-gray-700'">
            ...
            <div
              :class="
                isMyseedstory
                  ? 'border-l-2 border-myseedstory-clay bg-myseedstory-parch-warm px-5 py-4 mb-2'
                  : 'border-l-4 bg-amber-50 border-amber-500 p-4 mb-6'
              "
            >
              <p :class="isMyseedstory ? 'text-[14px] text-myseedstory-forest/80' : 'text-sm text-amber-800'">
          ...
          <div>
            ...
            <p :class="isMyseedstory ? 'text-[15px] leading-relaxed' : 'mb-4 text-gray-700'">
          ...
          <div>
            ...
            <p :class="isMyseedstory ? 'mb-5 text-[15px] leading-relaxed' : 'mb-2 text-gray-700'">
            ...
            <div
              :class="
                isMyseedstory
                  ? 'border border-myseedstory-parch-border bg-myseedstory-parch-warm px-6 py-5'
                  : 'rounded-lg p-4 mb-6 bg-gray-50'
              "
            >
              <p :class="isMyseedstory ? 'text-[15px] text-myseedstory-forest/90' : 'text-gray-700'">
                <strong>Email:</strong>
                <a
                  href="mailto:support@pomkatsu.com"
                  :class="
                    isMyseedstory
                      ? 'text-myseedstory-clay hover:text-myseedstory-clay-light border-b border-myseedstory-clay/40 ml-1'
              ...
              <p :class="isMyseedstory ? 'mt-2 text-[15px] text-myseedstory-forest/90' : 'mt-2 text-gray-700'">
                <strong>Subject:</strong> Delete My {{ appName }} Account
              </p>
            </div>
          </div>

          <p :class="isMyseedstory ? 'text-[13px] text-myseedstory-forest/60 pt-4' : 'text-sm mt-8 text-gray-600'">
            For more information about how we handle your data, please see our
            <router-link
              to="/privacy"
              :class="
                isMyseedstory
                  ? 'text-myseedstory-clay hover:text-myseedstory-clay-light border-b border-myseedstory-clay/40'
                  : 'text-amber-600 hover:text-amber-700'
              "
            >
